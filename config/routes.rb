Rails.application.routes.draw do
  ...
  devise_scope :user do
    get  "users/sign_up/select_role",
         to: "users/registrations#select_role",
         as: :select_role

    post "users/guest_admin_sign_in",
         to: "users/sessions#guest_admin_sign_in"

    post "users/guest_parent_sign_in",
         to: "users/sessions#guest_parent_sign_in"
    ...
    post   "admin/guest_login",
           to: "admin/sessions#guest_login",
           as: :admin_guest_login
  end
